...
| 0810   | 黑板异或游戏                          | hard               |                            |                    |
| 0826   | 安排工作以达到最大收益                | medium_other       |                            | UPDATE             |
...
| 1284   | 转化为全零矩阵的最少反转次数          | hard               | BFS                        | UPDATE             |
...
| 2028   | 找出缺失的观测数据                    | medium_math        |                            | UPDATE             |
...
| 2225   | 找出输掉零场或一场比赛的玩家          | medium_other       |                            | UPDATE             |
| 2233   | K 次增加后的最大乘积                  | stack_and_heap     | Heap                       |                    |
| 2244   | 完成所有任务需要的最少轮数            | medium_other       | Hashmap                    | UPDATE             |
...
| 2965   | 找出缺失和重复的数字                  | easy               | Bitwise operation          | UPDATE             |
| 2981   | 找出出现至少三次的最长特殊子字符串 I  | medium_string      |                            | UPDATE             |
| 2982   | 找出出现至少三次的最长特殊子字符串 II | medium_string      |                            | UPDATE             |
...
| 17_06  | 2出现的次数                           | hard               |                            |                    |
| 3147   | 从魔法师身上吸取的最大能量            | medium_math        |                            | UPDATE             |
| 3148   | 矩阵中的最大得分                      | medium_dp          | DP                         | UPDATE             |
| 3144   | 分割字符频率相等的最少子字符串        | medium_string      | DP                         | UPDATE             |
| 3146   | 两个字符串的排列差                    | easy               |                            | UPDATE             |
| 3142   | 判断矩阵是否满足条件                  | easy               |                            | UPDATE             |
| 3153   | 所有数对中数位不同之和                | medium_math        |                            | UPDATE             |
| 3143   | 正方形中的最多点数                    | medium_math        |                            | UPDATE             |
| 3152   | 特殊数组 II                           | medium_dp          | DP                         | UPDATE             |
| 3151   | 特殊数组 I                            | easy               |                            | UPDATE             |
| 3168   | 候诊室中的最少椅子数                  | easy               |                            | UPDATE             |
| 3169   | 无需开会的工作日                      | medium_other       |                            | UPDATE             |
| 3170   | 删除星号以后字典序最小的字符串        | medium_other       |                            | UPDATE             |
| 3171   | 找到按位与最接近 K 的子数组           | hard_dp            | DP                         | UPDATE             |
| 0307   | 区域和检索 - 数组可修改               | construct          | Segment tree               | UPDATE             |
| 2938   | 区分黑球与白球                        | medium_string      | Two pointers               | UPDATE             |
| 0406   | 根据身高重建队列                      | segment_tree       |                            | UPDATE             |
| 3040   | 相同分数的最大操作数目 II             | medium_dfs_or_bfs  | DFS                        | UPDATE             |
| 0312   | 戳气球                                | hard_dp            | DP                         | UPDATE             |
| 0881   | 救生艇                                | medium_other       |                            | UPDATE             |
| 0419   | 甲板上的战舰                          | medium_dfs_or_bfs  |                            | UPDATE             |
| 0149   | 直线上最多的点数                      | hard               |                            | UPDATE             |
| 0153   | 寻找旋转排序数组中的最小值 I          | medium_other       |                            | UPDATE             |
| 0154   | 寻找旋转排序数组中的最小值 II         | hard               |                            | UPDATE             |
| 0668   | 乘法表中第k小的数                     | hard               |                            | UPDATE             |
| 0639   | 解码方法 II                           | hard_dp            |                            | UPDATE             |
| 0514   | 自由之路                              | hard_dp            |                            | UPDATE             |
| 0895   | 最大频率栈                            | construct          |                            | UPDATE             |
